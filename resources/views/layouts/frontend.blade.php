                ...
                <div class="row text-center h-100vh align-items-center">
                    <div class="col-md-12">
                        ...
                        <h5>{{ __('We apologize for the inconvenience but') }} <span
                            ...
                            {{ __('is currently undergoing planned maintenance') }}.</h5>
                    </div>
                </div>
            </div>
        @else
                                        ...
                                        <div class="row">
                                            ...
                                            <nav class="navbar navbar-expand-lg navbar-light w-100"
                                                ...
                                                <a class="navbar-brand" href="{{ url('/') }}"><img id="brand-img"
                                                        src="{{ URL::asset('img/brand/logo.png') }}"
                                                        alt=""></a>
                                                                ...
                                                                <div>
                                                                    @auth
                                                                        <a href="{{ route('user.templates') }}"
                                                                            class="action-button dashboard-button pl-5 pr-5">{{ __('Dashboard') }}</a>
                                                                    @else
                                                                        <a href="{{ route('login') }}{{ request()->get('ref') ? '?ref=' . request()->get('ref') : '' }}"
                                                                            class="btn btn-primary special-action-button"
                                                                            id="login-button">{{ __('Login') }}</a>

                                                                        @if (config('settings.registration') == 'enabled')
                                                                            @if (Route::has('register'))
                                                                                <a href="{{ route('register') }}{{ request()->get('ref') ? '?ref=' . request()->get('ref') : '' }}"
                                                                                    class="ml-2 action-button register-button pl-5 pr-5">{{ __('Sign Up') }}</a>
                                                                            @endif
                                                                        @endif
                                                                    @endauth
                                                                </div>
    ...
    ========================================================-->
                    <footer id="welcome-footer">
                                                    ...
                                                    @if ($lang != App::getLocale())
                                                        <a href="{{ route('locale', $lang) }}"
                                                            ...
                                                            <div class="text-info"><i
                                                                    class="flag flag-{{ $language['flag'] }} mr-3"></i>
                                                            </div>
                                                            <div>
                                                                <span
                                                                    class="font-weight-normal fs-12">{{ $language['display'] }}</span>
                                                            </div>
                                                        </a>
                                                    @endif
                                                @endforeach
                                ...
                                <div class="col-md-8 col-sm-12" id="footer-links">
                                    ...
                                    <div class="row w-100">
                                        ...
                                        <div class="col-md-3 col-sm-12">
                                            ...
                                            <ul class="list-unstyled">
                                                <li><a href="{{ route('terms') }}">{{ __('Terms & Conditions') }}</a>
                                                </li>
                                                <li><a href="{{ route('privacy') }}">{{ __('Privacy Policy') }}</a>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="col-md-3 col-sm-12 footer-connect pr-0">
                                            ...
                                            <h6>{{ __('Follow up on social media to find out the latest updates') }}.
                                            </h6>

                                            <ul id="footer-icons" class="list-inline">
                                                @if (config('frontend.social_linkedin'))
                                                    <a href="{{ config('frontend.social_linkedin') }}"
                                                        target="_blank">
                                                ...
                                                @if (config('frontend.social_twitter'))
                                                    <a href="{{ config('frontend.social_twitter') }}"
                                                        target="_blank">
                                                        <li class="list-inline-item"><i
                                                ...
                                                @if (config('frontend.social_instagram'))
                                                    <a href="{{ config('frontend.social_instagram') }}"
                                                        target="_blank">
                                                        <li class="list-inline-item"><i
                                                ...
                                                @if (config('frontend.social_facebook'))
                                                    <a href="{{ config('frontend.social_facebook') }}"
                                                        target="_blank">
                                                        <li class="list-inline-item"><i
                        ...
                        <div id="copyright" class="container">
                            ...
                            <p class="copyright-left">{{ __('Copyright') }} © {{ date('Y') }} <a
                                    href="{{ config('app.url') }}">{{ config('app.name') }}</a>
                                {{ __('All rights reserved') }}</p>

                            <div>
                                <p class="copyright-right"><a href="{{ route('terms') }}"
                                        target="_blank">{{ __('Terms & Conditions') }}</a></p>
                                <p class="copyright-right"><a href="{{ route('privacy') }}"
                                        target="_blank">{{ __('Privacy Policy') }}</a><span>|</span></p>
                            </div>
